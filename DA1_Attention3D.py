...
a=K.dropout(sort_train_data[:500,:],0.15)
data_20_MAR[:500,:]=K.get_value(a)
b=a=K.dropout(sort_train_data[500:,:],0.25)
data_20_MAR[500:,:]=K.get_value(b)
...
a=K.dropout(sort_train_data[:500,:],0.3)
data_40_MAR[:500,:]=K.get_value(a)
b=a=K.dropout(sort_train_data[500:,:],0.5)
data_40_MAR[500:,:]=K.get_value(b)
...
acc_40_MAR, val_acc_40_MAR=NNmodel(train_data_40_MAR_elim,label_data_40_MAR_elim,np.expand_dims(data[:150,],axis=-1)
,float_data[:150,-1]) 
