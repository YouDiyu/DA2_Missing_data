...
val_data=K.get_value(K.dropout(data[:150,],0.2,None,None))*0.8
val_label=float_data[:150,1]
val_data,val_label=verarbeit_mulimp(val_data,val_label)
#validation data
# MCAR
...
#MAR
sort_float_data=sorted(float_data[150:], key=lambda x: x[2])
...
acc_voll, val_acc_voll=NNmodel(train_data_voll_elim,label_data_voll_elim,val_data,val_label)

acc_20_MCAR, val_acc_20_MCAR=NNmodel(train_data_20_MCAR_elim,label_data_20_MCAR_elim,val_data,val_label)
acc_40_MCAR, val_acc_40_MCAR=NNmodel(train_data_40_MCAR_elim,labe_data_40_MCAR_elim,val_data,val_label) 

acc_20_MAR, val_acc_20_MAR=NNmodel(train_data_20_MAR_elim,label_data_20_MAR_elim,val_data,val_label)
acc_40_MAR, val_acc_40_MAR=NNmodel(train_data_40_MAR_elim,label_data_40_MAR_elim,val_data,val_label) 
