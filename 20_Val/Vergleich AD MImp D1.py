# -*- coding: utf-8 -*-
"""
Created on Mon Feb 25 01:12:20 2019
...
epochs = range(1, len(adloss_voll) + 1 - 25)
plt.plot(epochs, adloss_voll[:25], 'b', label='AD loss voll')
plt.plot(epochs, adloss_20_MCAR[:25], 'r', label='AD loss 20 MCAR')
plt.plot(epochs, adloss_40_MCAR[:25], 'g', label='AD loss 40 MCAR')
plt.plot(epochs, adloss_20_MAR[:25], 'c', label='AD loss 20 MAR')
plt.plot(epochs, adloss_40_MAR[:25], 'm', label='AD loss 40 MAR')
plt.plot(epochs, miloss_voll[:25], 'b.', label='MI loss voll')
plt.plot(epochs, miloss_20_MCAR[:25], 'r.', label='MI loss 20 MCAR')
plt.plot(epochs, miloss_40_MCAR[:25], 'g.', label='MI loss 40 MCAR')
plt.plot(epochs, miloss_20_MAR[:25], 'c.', label='MI loss 20 MAR')
plt.plot(epochs, miloss_40_MAR[:25], 'm.', label='MI loss 40 MAR')
plt.xlabel('Epochs')
plt.ylabel('Loss')
