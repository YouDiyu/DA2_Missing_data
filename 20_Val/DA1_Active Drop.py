...
#validation data
# MCAR
train_data_voll=K.get_value(K.dropout(train_data,0.0001,None,None))
...
def NNmodel(train_data,label_data,val_data1,val_data2):
    ...
    history = model.fit(train_data, label_data,validation_data=(val_data1,val_data2),epochs=750,batch_size=64)
